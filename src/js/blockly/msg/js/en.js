...
Blockly.Msg.BUTTON_BOTTOM_LEFT = "Bottom left";
Blockly.Msg.BUTTON_BOTTOM_RIGHT = "Bottom right";
Blockly.Msg.BUTTON_PRESSED_HELPURL = "";
Blockly.Msg.BUTTON_PRESSED_TEXT = "Button Pressed";
Blockly.Msg.BUTTON_PRESSED_TOOLTIP = "";
Blockly.Msg.BUTTON_TOP_LEFT = "Top left";
Blockly.Msg.BUTTON_TOP_RIGHT = "Top right";
...
Blockly.Msg.CUSTOM_ARRAYS = "Arrays";
Blockly.Msg.CUSTOM_BLOCKS = "Blocks";
Blockly.Msg.CUSTOM_BUTTONS = "Buttons";
...
Blockly.Msg.LDR_TEXT = "Read light sensor";
...
Blockly.Msg.MATH_BITWISE_TOOLTIP_AND = "Return the bitwise-and of the two numbers.";
Blockly.Msg.MATH_BITWISE_TOOLTIP_OR = "Return the bitwise-or of the two numbers.";
...
Blockly.Msg.MATH_DECREMENT = "decrement--";
Blockly.Msg.MATH_DIVISION_SYMBOL = "÷";
Blockly.Msg.MATH_INCREMENT = "increment++";
...
Blockly.Msg.MATH_MAP_APPENDTEXT_MAP = "Map number";
...
Blockly.Msg.MATH_RANDOM_MAX_MIN_APPENDTEXT_RANDOM = "Random number";
Blockly.Msg.MATH_RANDOM_MAX_MIN_HELPURL = "";
...
Blockly.Msg.OLED_CLEAR_LINE = "Clear Line";
Blockly.Msg.OLED_CLEAR_RECTANGLE = "Clear Rectangle";
Blockly.Msg.OLED_DRAW_IMAGE = "Draw Image";
Blockly.Msg.OLED_DRAW_LINE = "Draw Line";
Blockly.Msg.OLED_DRAW_RECTANGLE = "Draw Rectangle";
Blockly.Msg.OLED_HELPURL = "";
Blockly.Msg.OLED_IMAGE_BABY_GROOT = "Baby-Groot-Black";
Blockly.Msg.OLED_IMAGE_BAT = "Bat";
Blockly.Msg.OLED_IMAGE_BOO = "boo";
Blockly.Msg.OLED_IMAGE_GHOSTBUSTERS = "Ghostbusters";
Blockly.Msg.OLED_IMAGE_JACKOLANTERN = "JackoLantern";
Blockly.Msg.OLED_IMAGE_KIDSPEAK = "Kidspeak";
Blockly.Msg.OLED_IMAGE_MICKEY = "Mickey-and-Minnie-Kissing";
Blockly.Msg.OLED_IMAGE_MUSHROOM = "mushroom";
...
Blockly.Msg.OLED_PRINT_NUM = "Number";
Blockly.Msg.OLED_PRINT_TEXT = "Text";
Blockly.Msg.OLED_PRINT_WIDTH = "Width";
Blockly.Msg.OLED_PRINT_X = "X";
Blockly.Msg.OLED_PRINT_X1 = "X1";
Blockly.Msg.OLED_PRINT_X2 = "X2";
Blockly.Msg.OLED_PRINT_Y = "Y";
Blockly.Msg.OLED_PRINT_Y1 = "Y1";
Blockly.Msg.OLED_PRINT_Y2 = "Y2";
